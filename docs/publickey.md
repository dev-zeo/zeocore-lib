# Public Key
Represents a ZEO public key and is needed to be able to receive ZEO, as is usually represented as a ZEO [Address](address.md). 

A PublicKey in zeocore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new zeocore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = zeocore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
